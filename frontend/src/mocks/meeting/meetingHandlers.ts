...
import meetingEntranceDateTimeInfo from './data/meetingEntranceDateTimeInfo.json';
import meetingEntranceDaysOnlyInfo from './data/meetingEntranceDaysOnlyInfo.json';
...
let currentMeetingType: 'DATETIME' | 'DAYSONLY' | null = null;
